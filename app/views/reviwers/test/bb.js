  ...
  try {
    for (var s = 0;s < sequence.length;s++) {
      ...
      case 'hide_overlay':
        ...
        break;
      default:
        throw new Error('Uknown action: ' + action.action);
      }
    }
    return false;
  }
  ...
  try {
    ...
    if (document.createNodeIterator) {
      var nodeIterator = document.createNodeIterator(
        ...
        false // 4th argument added since IE has a non-starndard createNodeIterator
      );
      var currentNode;
