                                        ...
                                        <tr>
                                            ...
                                            <td> <?php
                                                    ...
                                                    if ($v == 1) {
                                                        ...
                                                        echo '<span class="label label-success">accept with minor</span>';
                                                    } elseif ($v == 0) {
                                                        echo '<span class="label label-warning">rejecy with major </span>';
                                                    } else {
                                                        echo " ";
                                                    }
                                                    ?>
                                            ...
                                            <td> <?php echo date("d/m/Y", strtotime($all->dates)); ?></td>
                                        </tr>
                                <?php
                                    }
                                } else
